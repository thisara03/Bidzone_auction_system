    ...
    <div className="login-page">
        ...
        <div className="login-page__body">
          {step !== 'done' && step !== 'aml' && (
            <ol className="kyc-steps" aria-label={t('onboard.stepsLabel')}>
              {(props.mode === 'new' ? ['account', 'phone', 'otp', 'nic'] : ['phone', 'otp', 'nic']).map(
                (s, i) => {
            ...
            <form className="login-page__form" onSubmit={onNicNext}>
              ...
              <label className="login-page__field">
                ...
                <div
                  ...
                  style={{ alignItems: 'center', minHeight: 48, padding: '0.5rem 0.75rem' }}
                >
              ...
              <button type="submit" className="login-page__submit" disabled={!nicDataUrl}>
                {t('onboard.submitKyc')}
              </button>
            </form>
          )}
          ...
          {step !== 'done' && step !== 'aml' && (
            <p className="onboard-back">
              {props.mode === 'new' ? (
                ...
                <Link to="/home">{t('onboard.backHome')}</Link>
              )}
            </p>
          )}
        </div>
      ...
      <style>{`
        .kyc-steps {
          ...
          border-bottom: 1px solid var(--bz-card-border);
        ...
        .kyc-steps__dot {
          ...
          font-size: 0.75rem;
          font-weight: 700;
          background: var(--bz-card-border);
          color: var(--bz-text-muted);
        }
        .kyc-steps__dot--on {
          background: var(--bz-gold);
          color: var(--bz-bid-btn-text);
        }
        .kyc-hint {
          font-size: 0.875rem;
