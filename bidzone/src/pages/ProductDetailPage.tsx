...
import { BidCoachPanel } from '../components/BidCoachPanel'
...
/** Matches default `anti_sniping_minutes` on the API (see POST /auctions). */
...
export function ProductDetailPage() {
  ...
  const [remainSec, setRemainSec] = useState(() =>
    detail ? toSeconds(detail.countdownInitial) : 0,
  )
  ...
  return (
    <div className="product-detail">
      ...
      <div className="product-detail__wrap">
        <Link to="/home" className="product-detail__back">
          ...
          <div className="product-detail__col product-detail__col--main">
            ...
            <section className="product-detail__card">
              ...
              <dl className="product-detail__meta-grid">
                    ...
                    <span
                      className={
                        detail.sellerVerified
                          ? 'product-detail__seller product-detail__seller--verified'
                ...
                <div>
                  <dt>{t('product.startingBid')}</dt>
                  <dd>{formatMoney(detail.startingBid)}</dd>
                </div>
              </dl>
            </section>
            ...
            <div className="product-detail__card product-detail__card--sticky">
              ...
              <div className="product-detail__title-row">
                ...
                <div className="product-detail__icon-actions">
                  <button
                    ...
                    className={
                      inWishlist
                        ? 'product-detail__icon-btn product-detail__icon-btn--active'
              ...
              <div className="product-detail__stats">
                <span>
                  ...
                  {detail.bids} {t('product.bids')}
                </span>
                <span>
                  <Eye size={18} aria-hidden />
                  {detail.views.toLocaleString()} {t('product.views')}
                </span>
              </div>
              ...
              <div className="product-detail__countdown">
                ...
                <div className="product-detail__countdown-digits" aria-live="polite">
                  <span>
                    <em>{clock.h}</em>
                    <small>{t('product.hours')}</small>
                  </span>
                  <span>
                    <em>{clock.m}</em>
                    <small>{t('product.mins')}</small>
                  </span>
                  <span>
                    <em>{clock.s}</em>
                    <small>{t('product.secs')}</small>
                  </span>
                </div>
              </div>
              ...
              <section className="product-detail__win-block" aria-labelledby="win-prob-heading">
                <h2 id="win-prob-heading" className="product-detail__win-heading">
                  {t('product.winProbTitle')}
                </h2>
