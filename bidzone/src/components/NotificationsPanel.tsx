...
function bodyFor(
  ...
  if (n.kind === 'outbid' && n.meta.itemKey) {
    return t('notif.outbidBody', { item: t(n.meta.itemKey) })
  }
  if (n.kind === 'bid_placed' && n.meta.bidAmount != null) {
    if (n.meta.rawItem) {
      return t('notif.bidBodyItem', { amount: formatMoney(n.meta.bidAmount), item: n.meta.rawItem })
    }
  ...
  if (n.kind === 'won' && n.meta.itemKey) {
    return t('notif.wonBody', { item: t(n.meta.itemKey) })
  }
